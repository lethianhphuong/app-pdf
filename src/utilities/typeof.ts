...
export function isLabelInValue<T extends Record<string, any>>(value: T | unknown): value is Common.OptionWithKey<any> {
  return (
    getDataTypeString(value) === dataTypeLabels.object && 'value' in (value as Object) && 'label' in (value as Object)
  );
}
